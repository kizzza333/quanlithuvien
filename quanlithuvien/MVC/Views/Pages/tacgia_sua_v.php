        ...
        <div>
            ...
            ?>
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            ...
                            <!-- <input type="radio" name="txtGioitinh" value="Nam" <?php if ($row['GioiTinh'] == 'Nam') echo 'checked'; ?>> Nam
                            <input type="radio" name="txtGioitinh" value="Nữ" <?php if ($row['GioiTinh'] == 'Nữ') echo 'checked'; ?>> Nữ -->
                ...
                <tr>
                    <td>Số điện thoại</td>
                    <td>
                        <input type="number" name="txtDienthoai" value="<?php echo $row['DienThoai'] ?>"  placeholder="Nhập số điện thoại">
                    </td>
                </tr>
                <tr>
                    <td>Địa chỉ</td>
