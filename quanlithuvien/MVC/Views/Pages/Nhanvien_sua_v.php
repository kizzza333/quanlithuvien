        ...
        <div class="form-container">
            ...
            <form method="post" action="http://localhost/quanlithuvien/Danhsachnhanvien/suadl">
                <div class="form-group">
                    ...
                    ?>
                    <label for="macanbo">Mã nhân viên:</label>
                    <input type="text" class="form-control" id="macanbo" placeholder="Nhập mã nhân viên" name="txtMaCanBo" value="<?php echo $row['MaCanBo'] ?>" readonly>
                    
                    <label for="tencanbo">Tên nhân viên:</label>
                    <input type="text" class="form-control" id="tencanbo" placeholder="Nhập tên nhân viên" name="txtTenCanBo" value="<?php echo $row['TenCanBo'] ?>" required>
                    ...
                    <select id="chucvu" class="form-control" name="ddlChucVu">
                        <option value="">---Chọn chức vụ---</option>
                        <option value="Thủ thư" <?php if($row['ChucVu']=='Thủ thư') echo 'selected'; ?>>Thủ thư</option>
                        <option value="Thủ thư chuyên ngành" <?php if($row['ChucVu']=='Thủ thư chuyên ngành') echo 'selected'; ?>>Thủ thư chuyên ngành</option>
                        <option value="Nhân viên hỗ trợ" <?php if($row['ChucVu']=='Nhân viên hỗ trợ') echo 'selected'; ?>>Nhân viên hỗ trợ</option>
                    </select>
                    
                    <label for="dienthoai">Điện thoại:</label>
                    <input type="tel" id="dienthoai" class="form-control" placeholder="Nhập điện thoại" name="txtDienThoai" value="<?php echo $row['SoDienThoai'] ?>" required>
