                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td class="hidden"><?php echo $row['MaChiTietPhieu']; ?></td>
                                <td>
                                    <a href="http://localhost/quanlithuvien/giahanmuon_ctrl/sua/<?php echo $row['MaChiTietPhieu']; ?>" class="btn btn-primary" name ="btnsua">Gia Hạn</a>
                                </td>
                            </tr>
                    <?php
                            }
