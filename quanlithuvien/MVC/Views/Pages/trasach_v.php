...
<body>
    <form method="post" action="">
        ...
        <input type="text" id="txtTheDG" name="txtTheDG" value="<?php echo isset($data['phieuInfo']['TheDG']) ? $data['phieuInfo']['TheDG'] : ''; ?>" readonly>
        <br><br>
        <label for="txtMaCanBo">Mã cán bộ:</label>
        <input type="text" id="txtMaCanBo" name="txtMaCanBo" value="<?php echo isset($data['phieuInfo']['MaCanBo']) ? $data['phieuInfo']['MaCanBo'] : ''; ?>" readonly>
        <br><br>
