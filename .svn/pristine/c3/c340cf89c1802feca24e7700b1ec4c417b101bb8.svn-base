        ...
        <div class="form-container">
            <form method="post" action="http://localhost/quanlithuvien/giahanmuon_ctrl/suadl">
                <div class="form-group">
                    ...
                    <input type="text" id="myCanBo" class="form-control dd1" placeholder="Mã Cán Bộ" name="txtMaCanBo" value="<?php echo $row['MaCanBo'] ?>" readonly>
                    <label for="myTheDG">Thẻ Độc Giả</label>
                    <input type="text" id="myTheDG" class="form-control dd1" placeholder="Thẻ Độc Giả" name="txtTheDG" value="<?php echo $row['TheDG'] ?>" readonly>
                    ...
                    <input type="text" id="mySoLuong" class="form-control hidden" placeholder="" name="txtMaChiTietPhieu" value=" <?php echo $row['MaChiTietPhieu'] ?>" readonly>
                    <br>
                    <?php
                            }
                        }
