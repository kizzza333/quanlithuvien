   ...
   <form action="http://localhost/quanlithuvien/Nhanvien/them" method="post">
       <div class="form-container">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="macanbo" placeholder="Nhập mã nhân viên" name="txtMaCanBo" value="<?php if(isset($data['MaCanBo'])) echo $data['MaCanBo'] ?>" required>
                
                <label for="tencanbo">Tên nhân viên:</label>
                <input type="text" class="form-control" id="tencanbo" placeholder="Nhập tên nhân viên" name="txtTenCanBo" value="<?php if(isset($data['TenCanBo'])) echo $data['TenCanBo'] ?>" required>
                ...
                <select id="chucvu" class="form-control" name="ddlChucVu">
                    ...
                    <option value="Thủ thư chuyên ngành">Thủ thư chuyên ngành</option>
                    <option value="Nhân viên hỗ trợ">Nhân viên hỗ trợ</option>
                </select>
                
                <label for="dienthoai">Điện thoại:</label>
                <input type="tel" id="dienthoai" class="form-control" placeholder="Nhập điện thoại" pattern="[0-9]*" inputmode="numeric" name="txtDienThoai" value="<?php if(isset($data['SoDienThoai'])) echo $data['SoDienThoai'] ?>" required>
